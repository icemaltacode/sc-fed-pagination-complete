...
const EMPLOYEES = [
  { name: 'Alice Green', title: 'CEO' },
  { name: 'Bob Barker', title: 'CTO' },
  { name: 'Joe Doe', title: 'Senior Partner' },
  { name: 'Azat Mardan', title: 'Senior Advisor' },
  { name: 'Keith Vassallo', title: 'Chief Janitor' },
];
